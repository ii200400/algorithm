...
1. [구슬 탈출 2](https://www.acmicpc.net/problem/13460)
	+ [풀이](https://github.com/ii200400/algorithm/blob/master/Baekjoon/kotlin/src/13460.kt)
	+ [백준 공유 링크](http://boj.kr/b656b47f4d4549ee868ea576785bdcbd)
	+ 브루트 포스, 백트래킹 관련 문제로 문제 조건상 BFS로 해결하는 것이 적절해보이나, DFS로 풀었다.
	+ 코틀린으로 해결할 때, deepCopy를 신경쓰지 않고 풀이를 진행하여 해결 중 조금 진행이 막혔었다.
