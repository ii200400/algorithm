...
// 제출 공유 링크 : http://boj.kr/733f9747cc114bfcb481ece5fa4ab2cb
// 백준 거짓말

// 음.. 처음에는 부분집합 생각했는데 파티 회수가 최대 50번이라 절대 못할 것 같고..
// 진실을 아는 사람을 만나는 사람들 끼리는 진실만을 말할 수 밖에 없으므로.. 서로소 집합을 활용하면 될 것 같다.
// 즉, 진실을 아는 사람 집합과 그렇지 않은 사람들의 집합으로 나눠서 풀 것이다.

package com.baekjoon.problem.java1043;
